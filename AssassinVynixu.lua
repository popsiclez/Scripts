...
local Button = Category:AddButton("Synapse - ESP", function()
...
local Tab = Gui:AddTab("Player/More")
...
local Category = Tab:AddCategory("Scripts")
local Button = Category:AddButton("Infinite Yield", function()
...
local Button = Category:AddButton("Popsiclez - Aimbot", function()

    setclipboard("https://raw.githubusercontent.com/popsiclez/Scripts/main/aimbot.lua")
...
local label = Category:AddLabel("GUI By: Popsicle#5482")
local label = Category:AddLabel("Popsiclez - ESP By: Popsicle#5482")
